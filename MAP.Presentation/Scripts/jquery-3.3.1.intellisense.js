intellisense.annotate(jQuery, {
  ...
  'parseHTML': function() {
    ...
    ///   <param name="context" type="Element">Documentt element to serve as the context in which the HTML fragment will be created</param>
...
intellisense.annotate(jQuery.fn, {
  ...
  'init': function() {
    ...
    ///   <param name="context" type="">A DOM Element, Documentt, or jQuery to use as context</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Accepts a string containing a CSS selector which is then used to match a set of elements.</summary>
